...
class DomitoryScreen extends StatefulWidget {
  const DomitoryScreen({Key? key, required this.email}) : super(key: key);

  final String email;

  @override
  State<DomitoryScreen> createState() => _DomitoryScreenState();
}
                        ...
                        Center(
                            child: Text(
                                snapshot.data!.docs[0]["domitoryFee"]
                                    ...
                                    : "Sorry! You have outstanding domitory fees. Kindly clear all outstanding fees before you can continue with your clearance.",
